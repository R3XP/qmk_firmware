...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
       KC_ESC , KC_J   , KC_D    , KC_U   , KC_A    , KC_X   ,     KC_P   , KC_H    , KC_L   , KC_M    , KC_W   , KC_S,
    //|--------+--------+---------+--------+---------+--------|   |--------+---------+--------+---------+--------+--------|
      KC_G_TAB, KC_C   , KC_T    , KC_I   , KC_E    , KC_O   ,     KC_B   , KC_N    , KC_R   , KC_S    , KC_G ,   KC_Q,
    //|--------+--------+---------+--------+---------+--------|   |--------+---------+--------+---------+--------+--------|
       KC_LCTL, KC_F   , KC_V    , KC_U   , KC_O    , KC_A   ,     KC_Y   , KC_Z    , KC_COMM, KC_DOT  , KC_K, KC_RCTL,
    //`--------+--------+---------+--------+---------+--------/   \--------+---------+--------+---------+--------+--------'
                                  KC_A_DEL, _______ ,KC_L_SPC,    KC_R_ENT, _______ , KC_A_DEL
    //                           `+--------+---------+--------'   `--------+---------+--------+'
    ),
